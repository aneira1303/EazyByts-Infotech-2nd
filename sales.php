...
$total_revenue = $conn->query("SELECT SUM(total_price) AS total_revenue FROM sales")->fetch_assoc()['total_revenue'];
?>
    ...
    <form method="POST" action="sales.php">
        <select name="product_id" required>
            ...
            <?php while($row = $products->fetch_assoc()): ?>
                <option value="<?php echo $row['id']; ?>"><?php echo $row['product_name']; ?> (Stock: <?php echo $row['stock']; ?>)</option>
            <?php endwhile; ?>
        </select>
